...
showBG = function() {
	//Aenderung um flashmovies auszublenden
...
createIbox = function(elem) {
	...
	strHTML +=	"<div id=\"ibox_footer_wrapper\"><div id=\"ibox_close\" style=\"float:right;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;color:#666666;text-decoration:none;\">";
	strHTML +=	"<a style=\"text-decoration:none;\" id=\"ibox_close_a\" href=\"javascript:void(null);\" ></a></div>";
...
//					getElem('ibox_content').style.overflow = "auto";
	...
	if(ibox_type == 2 || ibox_type == 3) {
		ibox.onclick = null;getElem("ibox_w").onclick = function() {hideIbox();}
	} else {ibox.onclick = hideIbox;getElem("ibox_w").onclick = null;}
...
posToCenter = function(elem) {
	...
	var table_lightbox = document.getElementById("table_lightbox");
	elem.style.top = y+'px';	
}
